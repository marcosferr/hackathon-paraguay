    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Comparte los detalles de tu hackathon con la comunidad
        </p>

        <div className="bg-blue-50 p-6 rounded-lg mb-8">
          <h2 className="text-xl font-bold mb-2">1. Servicios gratuitos:</h2>
          <p className="text-gray-700">
            Rellena el siguiente formulario y publicamos tu hackathon web sin
            ningún coste para ti. Sí, lo has leído bien, aprovecha ahora la
            oportunidad de difundir tu evento gratis a todos los visitantes de
            nuestra página web 😊
          </p>
        </div>
        ...
        {isSuccess ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-green-600 mb-4">
              Hemos recibido los detalles de tu hackathon. Revisaremos la
              información y lo publicaremos pronto.
            </p>
            <Button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  El nombre del evento. Ejemplo: la fiesta de cumpleaños
                </p>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-6">Enlace del hackathon</h2>
              <div>
                <label
                  htmlFor="link"
                  className="block text-sm font-medium text-gray-700 mb-1"
                ...
                <Input
                  ...
                  name="link"
                  type="url"
                  placeholder="https://ejemplo.com/hackathon"
                  required
                />
                <p className="text-sm text-gray-500 mt-1">
                  Enlace a la página web oficial del hackathon
                </p>
              </div>
            </div>
